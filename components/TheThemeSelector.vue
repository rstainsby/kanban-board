<template>
  <fieldset id="color-scheme" :class="$style['theme-selector']">
    <div>
      ...
      <label for="system-theme" :class="$style['theme-label']">
    ...
    <div>
      <input 
        ...
        v-model="theme" 
        @change="setTheme(theme)">
      <label for="light-theme" :class="$style['theme-label']">
    ...
    <div>
      <input 
        ...
        v-model="theme" 
        @change="setTheme(theme)">
      <label for="dark-theme" :class="$style['theme-label']">
...
<style module>
  ...
  .theme-selector::after {
    ...
    border-radius: 100px;
    background-color: hsl(var(--cl-primary-text));
    z-index: 2;
    left: 0;
